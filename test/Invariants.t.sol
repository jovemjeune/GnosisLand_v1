...
contract InvariantsTest is Test {
    ...
    function test_Invariant5_MinimumPrice_25USDC() public {
        ...
        vm.prank(newTeacher);
        address lessonAddr = factory.createLessonNFT(
            teacherTokenId,
            MIN_PRICE,
            "Min Price Course",
            ""
    ...
    function test_Invariant7_ReferralReward_10Percent() public {
        ...
        assertTrue(
            treasuryIncrease >= expectedReward,
            "Treasury should have received referral reward USDC"
        );
        ...
        assertEq(
            referrerGlUSD,
            expectedReward,
            "Referrer should receive 10% of discounted price as GlUSD"
        );
        
        assertEq(
            treasury.underlyingBalanceOf(referrer),
            expectedReward,
            "Referrer underlying balance should match reward"
        );
    }

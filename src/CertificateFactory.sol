...
contract CertificateFactory {
    ...
    event CertificateContractCreated(
        address indexed teacher, address indexed certificateContract, string baseMetadataURI
    );
     ...
     */
    function createCertificateContract(address teacher, string memory baseMetadataURI, address lessonNFT)
        external
